...
them, and bring them to their knees. Well deserved if you ask me.
...
killing those trying to stop you in finding them. You are the best bounty
hunter the world has seen in years

    STORY

    Prompt.ask "Do you dare continue?"
    $stdin.gets.chomp
    return 'tavern'
  end
end